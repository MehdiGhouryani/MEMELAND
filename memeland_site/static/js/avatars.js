/**
 * MemeLand Vector Avatars Renderer
 * آواتارهای وکتوری میم‌کوینی اختصاصی هر نقش
 */

const AvatarRenderer = {
  getAvatarSvg(roleKey) {
    switch (roleKey) {
      // ۱. پپه‌ی طلایی تاج‌دار با عینک دودی (Admin)
      case 'admin':
      case 'super_admin':
        return `
      ...
      // ۲. سگ کلاه‌بافتنی چاد (VIP Helper / Dogwifhat)
      case 'vip_helper':
        return `
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      ...
      // ۳. دوج کوین با شنل سلطنتی (Memeland OG)
      case 'og':
        return `
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      ...
      // ۴. گوریل فضانورد با بازتاب نمودار کندل‌ها (Alpha Master)
      case 'alpha':
        return `
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- شیشه کلاه (Visor) فضانورد با رنگ تیره -->
            <ellipse cx="50" cy="52" rx="26" ry="20" fill="#09090b"/>
            <!-- بازتاب کندل‌های سبز پامپ روی شیشه کلاه -->
      ...
      // ۷. جوجه کریپتویی در پوست تخم‌مرغ (Rookie / Member / Default)
      case 'rookie':
      default:
        return `
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
